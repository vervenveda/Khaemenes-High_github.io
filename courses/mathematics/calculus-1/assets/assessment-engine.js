(() => {
"use strict";
const cfg=window.CALC1_ASSESSMENT_CONFIG||{};
const all=cfg.source==="diagnostic"?window.CALCULUS1_DIAGNOSTIC:window.CALCULUS1_QUESTIONS;
const host=document.getElementById("assessmentRoot");
if(!host||!Array.isArray(all))return;
const KEY="khaemenes-calculus1-assessment-records-v1";
