...
- `service-worker.js` — route-aware offline caching for the campus, Grade 9, Pre-Algebra, the diagnostic, and Units 1–5
...
1. Build Pre-Algebra Unit 6: Powers, Roots & Scientific Notation
