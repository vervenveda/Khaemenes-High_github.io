...
(() => {
 ...
 function syncRoot(){const isComplete=complete(),r=parse(localStorage.getItem(ROOT_KEY),{}),set=new Set(Array.isArray(r.completedUnits)?r.completedUnits:[]);if(isComplete)set.add("u02");else set.delete("u02");const courseSequenceComplete=["u00","u01","u02","u03","u04","u05","u06","u07","u08","u09","u10","u11","u12"].every(id=>set.has(id));localStorage.setItem(ROOT_KEY,JSON.stringify({...r,pathway:r.pathway||"Core",completedUnits:[...set],notes:r.notes&&typeof r.notes==="object"?r.notes:{},lastVisitedUnit:"u02",courseSequenceComplete,updatedAt:new Date().toISOString()}))}
