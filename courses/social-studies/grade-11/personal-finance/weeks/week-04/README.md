# Week 04 — Budgeting, Cash Flow, and Emergency Funds

**Unit:** Unit 2 · Banking, Budgeting, and Consumer Transactions  
**Frame:** Income · fixed and variable expense · savings  
**Essential question:** How can a budget remain realistic when income, prices, and unexpected needs change?
...
- **SS.912.FL.3.1** — Create and maintain a personal budget that reflects goals and constraints.
- **SS.912.FL.4.4** — Analyze the impact of spending versus saving.
- **SS.912.E.1.16** — Standards-aligned content and disciplinary practice.
