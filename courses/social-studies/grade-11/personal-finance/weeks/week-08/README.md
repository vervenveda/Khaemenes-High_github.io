# Week 08 — Loans, Interest, and Major Purchases

**Unit:** Unit 3 · Credit, Debt, and Consumer Law  
**Frame:** Installment credit · collateral · amortization  
**Essential question:** How should a borrower compare loans for vehicles, education, housing, or other major purchases?
...
- **SS.912.FL.5.3** — Explain secured and unsecured loans.
- **SS.912.FL.5.4** — Analyze factors affecting borrowing costs, including down payments and rates.
- **SS.912.FL.5.6** — Demonstrate understanding of completing a loan application.
