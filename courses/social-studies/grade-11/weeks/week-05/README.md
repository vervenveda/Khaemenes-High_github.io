# Week 05 — Constitutional Architecture

**Unit:** Unit 1 · Foundations of Constitutional Government  
**Frame:** Articles I–VII · amendments · structural principles  
**Essential question:** How does constitutional structure attempt to make government energetic enough to govern but limited enough to preserve liberty?
...
- **SS.912.CG.1.5** — Explain how the Constitution and amendments uphold core political principles.
- **SS.912.CG.3.3** — Analyze the structures, functions, and processes of the legislative branch under Article I.
- **SS.912.CG.3.4** — Analyze the structures, functions, and processes of the executive branch under Article II.
- **SS.912.CG.3.6** — Explain expressed, implied, concurrent, and reserved powers.
