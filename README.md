...
- `courses/mathematics/pre-algebra/units/unit-01/` — six lessons, three practice pathways, project, guides, standards map, and mastery check
...
1. Build Pre-Algebra Unit 2: Integers and Absolute Value
