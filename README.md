...
- `courses/mathematics/pre-algebra/units/unit-05/` — Percent, Financial Mathematics & Change
- `courses/mathematics/pre-algebra/units/unit-06/` — Powers, Roots & Scientific Notation
- `courses/mathematics/pre-algebra/units/unit-07/` — Variables, Expressions & Algebraic Structure
- `courses/mathematics/pre-algebra/units/unit-08/` — Equations, Formulas & Inverse Operations
- `courses/mathematics/pre-algebra/units/unit-09/` — Inequalities & Constraints
- `courses/mathematics/pre-algebra/units/unit-10/` — Coordinates, Patterns, Functions & Linear Relationships
- `courses/mathematics/pre-algebra/units/unit-11/` — Geometry, Measurement & Scale
...
- `service-worker.js` — route-aware offline caching for the campus, Grade 9, Pre-Algebra, the diagnostic, and Units 1–12
- `LICENSE`, `SECURITY.md`, and `CONTRIBUTING.md` — project governance and protection

Grade 10–12 portals, the remaining Pre-Algebra units, additional courses, standards overlays, translations, portfolios, teacher tools, counselor tools, and family resources remain in development.
...
9. Complete Pre-Algebra Units 1–12 with lessons, practice, assessment, projects, and offline support

Immediate next milestones:

1. Build Pre-Algebra Unit 13: Mathematical Modelling Capstone
...
- `courses/mathematics/pre-algebra/units/unit-12/`

## Formal assessments and completion records

- Units 01–07 midterm: 56 definitive-answer questions
- Complete 36-week final examination: 80 definitive-answer questions
- Parent-issued course completion certificate and detailed verification record
- Local score saving, section breakdowns, printable copies, and JSON exports
- Assessment administration guide and static answer-key record

The completion document supports a home education portfolio but does not claim government issuance, accreditation, or replacement of jurisdiction-specific annual evaluation requirements.
